...
def configure_retriever(upload_files):
    ...
    embeddings = OpenAIEmbeddings(api_key = os.environ.get("ARK_API_KEY"), base_url = "https://ark.cn-beijing.volces.com/api/v3")
...
# 5、如果session_state中没有消息记录或用户点击了清空聊天记录按钮,则初始化消息记录
